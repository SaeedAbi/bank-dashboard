    ...
    <div className={"flex justify-between items-center flex-wrap"}>
      <div className={"flex gap-4 items-center bg-white rounded-3xl py-6 px-9"}>
        <svg
          ...
          viewBox="-199.07 -199.07 861.09 861.09"
          stroke="#9c9e24"
        >
          <g
