    ...
    <div className={"flex flex-col gap-4 flex-shrink flex-grow"}>
      ...
      >
        <div className={"flex gap-8 items-center"}>
          ...
          <div className={"text-black text-base font-medium"}>Apple</div>
        </div>
        <div className={"text-black text-base font-medium"}>5400$</div>
        <div className={"text-base font-medium"}>+16</div>
      </div>
    </div>
  );
}
